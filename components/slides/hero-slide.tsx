...
export function HeroSlide({ onScrollNext }: HeroSlideProps) {
  ...
  if (tagId === "design" || tagId === "contents") {
    return {
      ...
      color: isActive ? "#9a9078" : "rgba(0,0,0,0.6)",
      fontWeight: 600,
    }
  }
  return {
